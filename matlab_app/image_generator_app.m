classdef image_generator_app < matlab.apps.AppBase
    ...
    methods (Access = private)
        ...
        function PreviewButtonPushed(app, event)
            ...
            %spot_intensity_range = [1000,1000 + 4 *200];
            ...
            max_uint16 = double(intmax("uint16"));
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            [img_blurred, label_img] = ImageGeneratorNoFig(width,height,num_spots,spot_radius,spot_intensity_range,min_distance_between_spots);
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.FluoIntensityRangeSliderLabel.Position = [1 190 118 22];
            ...
            app.FluoIntensityRangeSlider.Position = [122 200 152 3];
    ...
    methods (Access = public)
        ...
        % Construct app
        function app = image_generator_app
